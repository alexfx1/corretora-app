...
import { ContratoDto, SaveContrato, GetContratoById } from '@/components/service/ContratoService';
...
export default function EditarContrato() {
    ...
    // Clientes - Motoristas - Bancos - Contrato
    useEffect(() => {
        const fetchAll = async () => {
            setLoading(true);
            try {
                const contrato: ContratoDto = await GetContratoById(id as string);
                const mercadoriaDto: MercadoriaDto = {
                    flAtivo: contrato.mercadoria.flAtivo,
                    nome: contrato.mercadoria.dsMercadoria
                }
                ...
                parseContractInfo(contrato);
                setMercadoria(mercadoriaDto);
        ...
        fetchAll();
    }, [clients.length, motoristas.length, id]);
    ...
    const handleUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setContrato(contrato);
        await SaveContrato(contrato, id?.toString());
                ...
                <div className="flex flex-col w-full space-y-6 overflow-y-auto">
                    <div className="bg-white shadow-lg rounded-xl mt-10 p-10 space-y-5 m-10">
                        <div className="flex flex-row space-x-4 items-center">
                            <FilePenLine size={30}/>
                            <big><h1 className="text-2xl font-semibold text-gray-800">Editar Contrato</h1></big>
                        </div>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-5">
                            ...
                            {/*Data do contrato*/}
                            <div className='flex flex-col border-gray-400 border-2 p-4 rounded-md shadow-sm items-start gap-2'>
