...
import { ContratoDto, SaveContrato, GetContratoById, DownloadContract, TableContrato } from '@/components/service/ContratoService';
...
import { GetAllParametro } from "@/components/service/ParametroService";

export default function ContratoForm(pageTitle: string, id?: string) {
    ...
    useEffect(() => {
        const fetchAll = async () => {
            ...
            try {
                let contratoData: ContratoDto | null = null;
                ...
                if (id) {
                    contratoData = await GetContratoById(id as string);
                    ...
                    setContrato((prev) => ({...prev, ['dsDescricao']: description?.vlParametro ?? ""}));
                    setContrato((prev) => ({...prev, ['dsPadraoTolerancia']: padraoTolerancia?.vlParametro ?? ""}));
                }
                ...
                setButtonClients(dataClient.length > 0);
                setButtonMotoristas(dataMotorista.length > 0);
    ...
    const handleChangeObservacao = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        const { id, value } = e.target;
    ...
    const parseContractInfo = (contrato: ContratoDto) => {
        ...
        if(contrato.motorista) {
            setMotorista(contrato.motorista);
        }
    }
    ...
    const handleUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if(id) {
                await SaveContrato(contrato, id);
            }
            else {
                const resp = await SaveContrato(contrato);
                setContrato(resp);
            }
            setShowDownload(true);
    ...
    const parseContratoDate = (value: string) => {
    ...
    const downloadContract = async () => {
        ...
        if(id) {
            await DownloadContract(id!, corretor);
        } else {
            await DownloadContract(contrato.cdContrato.toString(), corretor);
        }
    }
                    ...
                    <div className="bg-white shadow-lg rounded-xl mt-10 p-10 space-y-5 m-10">
                        <div className="flex flex-row space-x-4 items-center">
                            ...
                            { showDownload && <>
                                <button 
                                    type="button" 
                                    className="bg-green-700 hover:bg-green-800 rounded px-2 py-1 text-white w-[60px] flex justify-center" 
                                    onClick={downloadContract}
                                >
                                    <Download className="items"/>
                                </button>
                            </> }
                        </div>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-5">
                                ...
                                <div className="flex flex-row space-x-5 items-center">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsNome' 
                                            type="text" 
                                            value={comprador.dsNome ? comprador.dsNome : ''} 
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='cdCpfCnpj' 
                                            type="text" 
                                            value={comprador.cdCpfCnpj ? comprador.cdCpfCnpj : ''} 
                                            maxLength={14} 
                                            onChange={handleChangeComprador}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsIns' 
                                            type="text" 
                                            value={comprador.dsIns ? comprador.dsIns : ''} 
                                            onChange={handleChangeComprador}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[784px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsEndereco' 
                                            type="text" 
                                            value={comprador.dsEndereco ? comprador.dsEndereco : ''} 
                                            onChange={handleChangeComprador}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[350px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsCidade' 
                                            type="text" 
                                            value={comprador.dsCidade ? comprador.dsCidade : ''}
                                            onChange={handleChangeComprador}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                ...
                                <div className="flex flex-row space-x-5 items-center">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsNome' 
                                            type="text" 
                                            value={vendedor.dsNome ? vendedor.dsNome : ''} 
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='cdCpfCnpj' 
                                            type="text" 
                                            value={vendedor.cdCpfCnpj ? vendedor.cdCpfCnpj : ''} 
                                            maxLength={14} 
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsIns' 
                                            type="text" 
                                            value={vendedor.dsIns ? vendedor.dsIns : ''} 
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[784px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsEndereco' 
                                            type="text" 
                                            value={vendedor.dsEndereco ? vendedor.dsEndereco : ''} 
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[350px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsCidade' 
                                            type="text" 
                                            value={vendedor.dsCidade ? vendedor.dsCidade : ''}
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                ...
                                <div className="flex flex-row space-x-5 items-center">
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='cdCpf' 
                                            type="text" 
                                            value={motorista.cdCpf ? motorista.cdCpf : ''} 
                                            maxLength={14} 
                                            onChange={handleChangeMotorista}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsPlaca' 
                                            type="text" 
                                            value={motorista.dsPlaca ? motorista.dsPlaca : ''} 
                                            onChange={handleChangeMotorista}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[350px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsCidade' 
                                            type="text" 
                                            value={motorista.dsCidade ? motorista.dsCidade : ''} 
                                            onChange={handleChangeMotorista}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                ...
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[350px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            type="text" 
                                            value={contrato.dsPesoQualidade ? contrato.dsPesoQualidade : ''} 
                                            onChange={handleChangeContrato}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[276px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsCargaConta' 
                                            type="text" 
                                            value={contrato.dsCargaConta ? contrato.dsCargaConta : ''} 
                                            onChange={handleChangeContrato}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-row space-x-5 items-center mt-4">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[700px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            type="text" 
                                            value={contrato.dsPadraoTolerancia ? contrato.dsPadraoTolerancia : ''} 
                                            onChange={handleChangeContrato}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row space-x-5 items-center mt-4 w-full">
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='w-[276px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='dsArmazenagem' 
                                            type="text" 
                                            value={contrato.dsArmazenagem ? contrato.dsArmazenagem : ''} 
                                            onChange={handleChangeContrato}
                                        />
                                    </div>
                                    <div className='flex flex-col w-full'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            type="text" 
                                            value={contrato.dsEnderecoEntrega ? contrato.dsEnderecoEntrega : ''} 
                                            onChange={handleChangeContrato}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row space-x-5 mt-4">
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='cdAgencia' 
                                            type="text" 
                                            value={vendedor.cdAgencia ? vendedor.cdAgencia : ''}
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            ...
                                            name='cdConta' 
                                            type="text" 
                                            value={vendedor.cdConta ? vendedor.cdConta : ''}
                                            onChange={handleChangeVendedor}
                                        />
                                    </div>
                                </div>
                            ...
                            <div className='flex flex-col border-gray-400 border-2 p-4 rounded-md shadow-sm'>
                                <div className='flex flex-row gap-4 mb-4'>
                                    <span className='font-semibold text-[20px]'>Comissão - Meus Dados</span>
                            ...
                            <div className='flex flex-col border-gray-400 border-2 p-4 rounded-md shadow-sm'>
                                <div className='flex flex-row gap-4 mb-4'>
                                    <span className='font-semibold text-[20px]'>Observações</span>
                                </div>
                                <div className="flex flex-row space-x-5">
                                    <div className='flex flex-col w-full'>
                                        <textarea className='px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm transition' 
                                            id="dsDescricao"
                                            name="dsDescricao"
                                            rows={5}
                                            value={contrato.dsDescricao}
                            ...
                            <div className='flex flex-col border-gray-400 border-2 p-4 rounded-md shadow-sm items-center gap-2'>
                                ...
                                <DatePicker
                                    selected={ contrato.dtContrato ? parseContratoDate(contrato.dtContrato) : null }
